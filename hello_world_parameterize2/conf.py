...
xsct_xsa = "{ROOT}/hello_world_parameterize2/hello_world/src/system.xsa"  # ZynqMP HW Designs xsa file
xsct_proc_name = "psu_cortexa53_0"  # For ZynqMP Processor

# running hello world application specific configurations
fsbl_path = (
    "{ROOT}/build/{machine}/hello_world_parameterize2/fsbl/images/zynq_mp_fsbl.elf"
)
elf_path = "{ROOT}/build/{machine}/hello_world_parameterize2/hello_world/images/empty_application.elf"
proc = "Cortex-A53*#0"
